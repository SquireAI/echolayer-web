...
<div class="grid h-full place-content-center">
	<div class="flex flex-col items-center gap-y-4">
		...
		<p class="text-center">Sorry, we can’t find the page you’re looking for.<br />Try going back to the previous page or contact us at <a href="mailto:support@echolayer.com" class="ext-blue-600 dark:text-blue-500 hover:underline">support@echolayer.com</a> on email or Slack for assistance.</p>
		...
		<div class="flex flex-col md:flex-row gap-4 w-full">
			...
			<Button type="secondary" full href="mailto:mailto:support@echolayer.com">Contact support</Button>
		</div>
</div>
</div>
