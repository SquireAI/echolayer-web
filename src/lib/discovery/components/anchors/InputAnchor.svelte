<script lang="ts">
	...
	/**
	 * Input anchor needs to accept a collection of [nodeId, nodeAnchorId] tuples
	*/
	// console.log(anchorConnections);
	// const connections: Connections = toNodeConnections(anchorConnections);
