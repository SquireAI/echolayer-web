<script lang="ts">
	import type { BaseEntity, TeamEntity } from '$lib/types';
...
<Node id={id} let:grabHandle let:selected borderRadius={0} borderColor="transparent" borderWidth={1} position={origin} dimensions={{ width: 240, height: 120 }}>
