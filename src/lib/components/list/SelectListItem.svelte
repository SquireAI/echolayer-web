...
<div>
    <a on:click={clickHandler} class={`text-neutral-600 hover:bg-neutral-200 w-full hover:cursor-pointer rounded p-2 flex flex-row gap-3 place-items-center
		${
        ...
        <div class="bg-white rounded h-9 w-9 flex items-center justify-center"><slot name="icon" /></div>
